...
ROOT_DIR = "C:/Users/ilbam/Desktop/wkladkauczenia"
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        # Add classes. We have only one class to add.
        self.add_class("object", 1, "stanowisko")
        ...
        annotations1 = json.load(open('C:/Users/ilbam/Desktop/wkladkauczenia/dataset/train/train.json'))
        # print(annotations1)
...
def train(model):
    ...
    dataset_train.load_custom("C:/Users/ilbam/Desktop/wkladkauczenia/dataset", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("C:/Users/ilbam/Desktop/wkladkauczenia/dataset", "val")
    dataset_val.prepare()
